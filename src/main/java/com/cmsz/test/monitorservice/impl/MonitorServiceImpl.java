...
import com.cmsz.test.bean.MonitorInfoBean;
import com.cmsz.test.monitorservice.IMonitorService;
...
//		MonitorInfoBean monitorInfo = (MonitorInfoBean) factory.getBean("monitorCPU");
		...
		System.out.println("总的物理内存=" + monitorInfo.getTotalMemorySize()/1024 + "M");
		System.out.println("剩余的物理内存=" + monitorInfo.getFreeMemory()/1024 + "M");
		System.out.println("已使用的物理内存=" + monitorInfo.getUsedMemory() /1024+ "M");
